...
## Open Tasks
- [ ] Work with Dean on the **parallel clean-sheet** combined dashboard: scaffold all renewal stages (~6–7 modules incl. negotiation + close) from a single data model, then fill one spec at a time (evening standup, 2026-06-22)

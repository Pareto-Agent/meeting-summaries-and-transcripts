...
## Open Tasks
- [ ] Refine the rebuilt proposal/deck dashboard, then push it into the Combined Dashboard (evening standup, 2026-06-22 — holding off until less buggy)
- [ ] Work with Aaron on the **parallel clean-sheet** combined dashboard: scaffold all renewal stages (~6–7 modules incl. negotiation + close) from a single data model, fill one spec at a time (evening standup, 2026-06-22)
- [ ] Draft the combined/clean-sheet spec (Cooper: Dean "has the best vision") (2026-06-22)
- [ ] Build the drag-and-drop deck editor / block library (targeted for 2026-06-22)
- [ ] Prepare renewal deck module demo for AJ call on 2026-06-25
